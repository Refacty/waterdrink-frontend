  ...
  const Estilo = StyleSheet.create({
    ...
    return (
        <SafeAreaView style={Estilo.container}>
            <Text className="text-lg" style={{fontFamily:'Lato_900Black', color:'#007784'}}>Você bebeu 20 Litros de água.</Text>
            ...
            <Modal>
                <Text>Teste do modal</Text>
            </Modal>

            <Text className="text-8xl bottom-44" style={{fontSize:80, fontFamily:'Lato_900Black', color:'#007784'}}>80%</Text>
