      ...
      <Modal isVisible={isModalVisible} style={{ alignItems: 'center' }} coverScreen={false}>
        <View>
          ...
          <View style={{ flexDirection: 'row', justifyContent: 'space-around', marginTop: -900 }}>
            ...
            <View style={{ margin: 10, padding: 20, backgroundColor: 'white', borderRadius: 10, alignItems: 'center', left: 200, bottom: 170 }}>
              <Image
            ...
            <View style={{ margin: 10, padding: 20, backgroundColor: 'white', borderRadius: 10, alignItems: 'center' }}>
              <Image
            ...
            <View style={{ margin: 10, padding: 20, backgroundColor: 'white', borderRadius: 10, alignItems: 'center', right: 200, bottom: 170 }}>
              <Image
