...
const create_user = (obj) => {
  return new Promise((resolve, reject) => {
    db.transaction((tx) => {
      ...
      tx.executeSql(
        "INSERT INTO tb_user (user_id, user_name, user_email, user_birthday, user_daily_progress, user_profession, user_weekly_progress, user_weight, user_session, user_logado) values (? ,? ,? ,? ,? ,? ,?, ?, ?, ?);",
        [obj.user_id, obj.user_name, obj.user_email, obj.user_birthday, obj.user_daily_progress, obj.user_profession, obj.user_weekly_progress, obj.user_weight, obj.user_session, obj.user_logado],
        //-----------------------
